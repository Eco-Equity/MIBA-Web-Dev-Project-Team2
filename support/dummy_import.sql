...
INSERT INTO `customers` (`cust_id`, `firstname`,  `lastname`,   `username`, `gender`, `phone_number`, `street`, `street_number`, `compl_adr_info`, `city`, `zip_code`, `mail` ,  `DOB` ,  `password`, `nationality`,  `member_since`) VALUES
